    ...
    class LoginView: UIView {
        ...
        private func setUI() {
            ...
            [titleLabel, idTextField, passwordField, clearTextButtonForID, clearTextButtonForPW, passwordEyeButton, loginButton, findStackView, createAccountStackView]
        ...
        private func setLayout() {
            ...
            loginButton.snp.makeConstraints {
                $0.top.equalTo(passwordField.snp.bottom).offset(25)
                $0.leading.trailing.equalToSuperview().inset(20)
                $0.height.equalTo(52)
            }
